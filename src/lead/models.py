...
class Lead(models.Model):
    ...
    priority = models.CharField(max_length=255, choices=CHOICES_PRIORITY, default=LOW)
    assign_to = models.ForeignKey(User, related_name='assignedleads', blank=True, null=True, on_delete=models.SET_NULL)
